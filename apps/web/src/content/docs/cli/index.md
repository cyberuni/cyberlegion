...
Reach for the CLI directly when you already know exactly which command you need, such as scripting a
...
`$CYBERLEGION_ROOT`. That is useful for tests and for running multiple independent hubs side by side.
