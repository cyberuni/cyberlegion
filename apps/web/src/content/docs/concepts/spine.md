---
title: The Spine
description: The three nouns behind every cyberlegion command, namely agent (definition), unit (instance), and pane (location).
---
...
| **`unit`** | instance | a spawned, registered agent with its own record and its own inbox; the thing you address |
