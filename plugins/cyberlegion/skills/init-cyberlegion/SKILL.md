...
>
> - **A version is found** → use it for every `npx cyberlegion@0.3.0 ...` call below, **and** pass
...
```bash
npx cyberlegion@0.3.0 mux doctor
```
...
```bash
npx cyberlegion@0.3.0 init --pin <version>
```
...
```bash
npx cyberlegion@0.3.0 init --pin <version> --agent <name>
```
...
```bash
npx cyberlegion@0.3.0 unit register --standing --handle legate
npx cyberlegion@0.3.0 attach
```
