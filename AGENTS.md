...
| Path | Read by |
| --- | --- |
| `plugin.json` | canonical Agent Plugins manifest — edit this one |
| `.claude-plugin/plugin.json` | Claude Code — generated by `universal-plugin plugin build`, never hand-edit |
| `.codex-plugin/plugin.json` | Codex — generated by `universal-plugin plugin build`, never hand-edit |
