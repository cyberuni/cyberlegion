...
approval:
  spec:
    ...
    why:
      ...
      judge: cold sdd-spec-judge round 3 — oracle/builder/architect all PASS; ALIGNED true; SCENARIOS_FAILING []; 24/24 scenarios clean in `mail/surface`, 60/60 in `unit/lifecycle`; no blocker, no open questions.
